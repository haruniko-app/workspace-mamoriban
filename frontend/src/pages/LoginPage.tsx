              ...
              <div className="text-white">
                ...
                <div className="flex flex-wrap gap-4 text-base">
                  <div className="flex items-center gap-2 text-white">
                    ...
                    <span className="font-semibold">ファイル内容にアクセスしません</span>
                  </div>
                  <div className="flex items-center gap-2 text-white">
                    <svg className="w-5 h-5 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="font-semibold">ISMS/Pマーク対応PDF出力</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:ml-auto w-full max-w-md">
                <div className="bg-white rounded-2xl shadow-2xl shadow-blue-900/20 p-8">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-3 border-2 rounded-xl px-6 py-4 font-medium transition-all ${
                      agreedToTerms
                        ? 'bg-white border-gray-200 text-gray-700 hover:border-blue-400 hover:shadow-lg cursor-pointer'
