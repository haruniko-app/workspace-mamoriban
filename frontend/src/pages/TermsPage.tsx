  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-semibold text-gray-800 mb-4">利用規約</h1>
        ...
        <div className="space-y-8 text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">1. 同意</h2>
            <p>本サービスを使用することにより、本規約およびプライバシーポリシーに同意したものとみなされます。</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">2. サービスの説明</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">3. 要件</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">4. 許可される使用</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">5. 禁止される使用</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">6. 知的財産</h2>
            <p>本サービスは知的財産法により保護されています。お客様のGoogle Drive™内のコンテンツはお客様の所有物のままです。</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">7. 料金</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">8. 免責</h2>
            <p>本サービスは「現状のまま」提供され、いかなる種類の保証もありません。</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">9. 責任の制限</h2>
            <p>間接的、偶発的、または結果的な損害について責任を負いません。</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">10. 変更</h2>
            <p>本サービスをいつでも変更または中止する場合があります。変更後の継続使用は同意を構成します。</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">11. 終了</h2>
            <p>違反に対してアクセスを終了する場合があります。いつでもアカウントを削除できます。</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">12. 準拠法</h2>
            <p>本規約は日本法に準拠します。</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">13. 連絡先</h2>
            <p>
